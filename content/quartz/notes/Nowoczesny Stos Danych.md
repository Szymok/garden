...
**[[Stos danych|Nowoczesny Stos Danych]] (ang. Modern [[Stos danych|Data Stack]], MDS)** to zestaw modularnych, często open-source’owych narzędzi, które razem zapewniają kompleksowy cykl przetwarzania danych – od integracji i transformacji, przez orkiestrację, po analitykę i [[Uczenie Maszynowe|machine learning]]. Kluczową cechą tego podejścia jest elastyczność oraz możliwość łączenia najbardziej wyspecjalizowanych narzędzi jak klocki LEGO.
...
|**Orkiestracja**|[[Apache Airflow\|Airflow]], [[Dagster]], Prefect|Zarządzanie kolejnością i zależnościami między zadaniami|
...
|**[[Business Intelligence\|BI]] / Analityka**|Looker, Metabase, Hex, Power [[Business Intelligence\|BI]]|Dostarczanie wizualizacji, eksploracja danych przez użytkowników biznesowych|

## Ujęcie ewolucyjne

[[Stos danych|Nowoczesny Stos Danych]] to efekt rozpadu monolitycznych platform typu ETL + hurtownia + [[Business Intelligence|BI]] na wyspecjalizowane komponenty – jak opisuje [Görkem](https://blog.fal.ai/the-unbundling-of-airflow-2/), mamy do czynienia z „rozbiórką stosu danych”. Powstałe nisze rynkowe wypełniają narzędzia skoncentrowane na konkretnych funkcjach.

## Nowe koncepcje: MDS 2.0, ngods

- **MDS 2.0**: zaawansowane podejście zawierające ulepszoną interoperacyjność, automatyzację zarządzania danymi i jeszcze dokładniejszą integrację z AI/[[Uczenie Maszynowe|ML]].
- **ngods** (next-generation open [[Stos danych|data stack]]): kierunek oparty na 100% open source, cloud-native i composable architekturze.
...
- Stos: modularny zbiór narzędzi (ETL, [[Business Intelligence|BI]], Orkiestracja, Obserwowalność) → elastyczność > platformy all-in-one.
