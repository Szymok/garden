...
## Denormalizacja
**Denormalizacja**, z drugiej strony, to proces celowego wprowadzania redundancji do projektu bazy danych poprzez łączenie tabel lub dodawanie nadmiarowych danych, mający na celu poprawę wydajności zapytań lub uproszczenie struktury bazy danych. Denormalizacja jest **odwrotnością normalizacji**. Proszę wziąć pod uwagę kompromis między integralnością danych a wydajnością zapytań. Ta technika jest stosowana w [Modelowaniu Wymiarowym](notes/modelowanie%20wymiarow.md) w kostkach [OLAP](OLAP%20(Online%20Analytical%20Processing).md), na przykład.
