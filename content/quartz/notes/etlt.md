...
- koncepcja
---
EtLT odnosi się do podejścia Ekstrakcja, "dostosowanie", Ładowanie, [Przekształcanie](notes/transformacje%20danych.md) i można je uznać za rozszerzenie podejścia [ELT](ELT.md) do [integracji danych](notes/integracja%20danych.md).
