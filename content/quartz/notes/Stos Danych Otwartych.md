...
|Transformacje (T)|[[dbt]]|SQL-first [[modelowanie danych]] w hurtowni lub [[Data Lakehouse\|lakehouse]]|
...
- **Modern [[Stos danych|Data Stack]]** — pojęcie szerokie, często używane w kontekście narzędzi SaaS (np. Fivetran, Snowflake, Looker, [[dbt]]).
