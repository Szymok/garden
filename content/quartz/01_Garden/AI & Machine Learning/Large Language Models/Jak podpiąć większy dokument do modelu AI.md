...
---
# 🎯 Definicja
Modele AI mają **okno kontekstowe** (np. [[GPT-4|GPT-4]]: 128k tokenów, Claude 3: 200k+). Jeśli Twój dokument jest większy lub chcesz zaoszczędzić pieniądze, musisz użyć technik takich jak **Chunking** (dzielenie) lub **[[RAG|RAG]]** (wyszukiwanie), aby "podpiąć" dokument do modelu.
...
3.  **[[RAG|RAG]]:** Wyszukiwanie tylko potrzebnych fragmentów w bazie wektorowej i wysyłanie ich do modelu.
...
4.  **[[RAG|RAG]] (Retrieval Augmented Generation):** Najlepsze do "rozmowy z dokumentacją".

# 💡 Przykład zastosowania
Masz ustawę podatkową (500 stron). Pytasz: "Jaka jest stawka VAT na pączki?".
- **Bez [[RAG|RAG]]:** Model zgaduje (halucynuje).
- **Z [[RAG|RAG]]:** System szuka słów "VAT", "stawka", "pączki" w ustawie. Znajduje "Art. 45 par. 3". Wysyła do ChatGPT tylko ten jeden paragraf. ChatGPT odpowiada precyzyjnie.

## 📌 Źródła
- [[Langchain|LangChain]] Documentation - Document Loaders & Splitters.
