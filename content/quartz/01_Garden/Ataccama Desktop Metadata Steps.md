...
1. **Analują konfigurację systemu** (np. "pobierz listę wszystkich reguł DQ" używając *ONE Metadata Reader*).
2. **Automatyzują konfigurację** (np. "utwórz nowe glosariusze dla każdej tabeli w bazie" używając *ONE Metadata Writer*).
...
1. Użyj **ONE Metadata Reader**, aby pobrać ID wszystkich haseł ze statusem "Draft".
2. W planie zmień wartość atrybutu status.
3. Użyj **ONE Metadata Writer**, aby wysłać zaktualizowane obiekty z powrotem do ONE Web App.
