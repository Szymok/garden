...
---
# 🎯 Definicja
**Tworzenie Jakości w kontekście Lean** to podejście do zarządzania projektami i procesami (w tym [[DevOps|DevOps]]), które skupia się na praktycznym redukowaniu marnotrawstwa i szacunku do ludzi, wykorzystując analityczne metody poprawy efektywności.

# 🔑 Kluczowe punkty
- **Analiza Pareto (80/20):** 80% problemów (defektów) wynika z 20% przyczyn. Największy zysk z wdrożenia [[DevOps|DevOps]] daje skupienie się na tym wąskim gardle.
