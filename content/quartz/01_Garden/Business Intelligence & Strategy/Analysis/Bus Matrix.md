...
---
# 🎯 Definicja
**Bus Matrix** to narzędzie projektowe w metodyce Kimballa (Data Warehousing), służące do mapowania procesów biznesowych (Wiersze) na współdzielone [[Wymiary|wymiary]] (Kolumny). Definiuje architekturę szyny danych.

# 🔑 Kluczowe punkty
- **Conformed [[Dimensions|Dimensions]]:** Święty Graal hurtowni danych. Wymiar "Klient" lub "Data" powinien być taki sam dla Sprzedaży, Marketingu i Logistyki.
...
Kolumny: [[Wymiary|Wymiary]] (Data, Sklep, Produkt, Klient, Promocja).
...
1. **[[Fakty|Fakty]] Sprzedaży:** Potrzebują: Daty, Sklepu, Produktu, Klienta.
2. **[[Fakty|Fakty]] Magazynowe:** Potrzebują: Daty, Sklepu, Produktu. (Klient nie ma tu sensu).
