...
---
# 🎯 Definicja
**RNN** to sieci neuronowe, które mają "pamięć". Zostały stworzone do przetwarzania sekwencji (tekstu, dźwięku, cen giełdowych), gdzie kolejność ma znaczenie.
...
- **Problem:** Krótka pamięć (Vanishing Gradient). RNN słabo radzi sobie z długimi tekstami. (Dlatego powstało [[Long Short-term Memory Network (LSTM)|LSTM]]).
