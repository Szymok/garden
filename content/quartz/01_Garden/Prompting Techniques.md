...
4.  **Self-Consistency:** Zapytaj model 3 razy o to samo i wybierz najczęstszą odpowiedź (Głosowanie). _Redukuje błędy losowe._
5.  **Tree of Thoughts (ToT):** Kazanie modelowi symulować kilku ekspertów dyskutujących nad problemem. _Dla bardzo trudnych problemów kreatywnych._
