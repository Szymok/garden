...
---
# 🎯 Definicja
**AQL (Advanced Query Language)** to specjalistyczny językiem zapytań wykorzystywany w systemach zarządzania metadanymi (np. [[Ataccama|Ataccama]] ONE), służący do wyszukiwania, filtrowania i agregowania obiektów w katalogu danych.
...
- **Zastosowanie:** Dynamiczne widoki w GUI, automatyzacja w regułach [[Data Quality|Data Quality]], raportowanie.

# 📚 Szczegółowe wyjaśnienie
AQL przypomina [[SQL|SQL]], ale zamiast na wierszach i kolumnach, operuje na Obiektach (Items) i ich Właściwościach (Properties).
...
## 📌 Źródła
- [[Ataccama|Ataccama]] ONE Documentation (AQL Reference).

## 👽 Brudnopis
- AQL ≈ [[SQL|SQL]]/Cypher → dedykowany metamodelowi, nie tabelom produkcyjnym.
