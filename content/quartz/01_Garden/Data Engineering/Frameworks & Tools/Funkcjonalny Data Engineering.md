...
---
# 🎯 Definicja
**Funkcjonalny Data Engineering** to filozofia budowania pipeline'ów danych inspirowana programowaniem funkcyjnym. Traktuje [[Przetwarzanie danych|przetwarzanie danych]] jako czystą funkcję: `Output = f(Input)`. Kluczowe zasady to **Immutability** (nie zmieniaj danych, twórz nowe wersje) i **Idempotency** (wielokrotne uruchomienie tego samego procesu daje ten sam wynik).
...
- **Nowoczesne narzędzia:** [[Apache Airflow|Apache Airflow]], [[dbt|dbt]], [[Dagster|Dagster]] – zostały zbudowane na tych zasadach.
...
Partycjonowanie w [[Data Lake|Data Lake]].
...
## 📌 Źródła
- "Functional Data Engineering" - [[Maxime Beauchemin|Maxime Beauchemin]] (twórca Airflow i Superset).
