...
# 🔑 Kluczowe punkty
- **[[Kursor|Kursor]]:** Pole, które mówi nam "gdzie skończyliśmy". Zazwyczaj `updated_at` (data modyfikacji) lub `id` (autoincrement).
- **Rodzaje:**
...
System ELT (np. [[Airbyte|Airbyte]]) zapamiętuje "stan" (State) - czyli maksymalną wartość kursora z poprzedniego uruchomienia.

# 💡 Przykład zastosowania
Synchronizacja danych z Salesforce do [[Snowflake|Snowflake]].
Używamy pola `LastModifiedDate` jako kursora.
[[Airbyte|Airbyte]] pyta Salesforce: "Daj mi wszystkie rekordy zmienione po `2023-10-27 15:00:00`".
Salesforce zwraca małą paczkę JSON.
[[Airbyte|Airbyte]] ładuje ją do [[Snowflake|Snowflake]] i aktualizuje swój stan na `2023-10-27 16:00:00`.

## 📌 Źródła
- [[Airbyte|Airbyte]] Documentation - Incremental Sync.
