...
---
# 🎯 Definicja
**Ewolucja Schematu** to zdolność systemu bazodanowego (zwłaszcza [[Data Lakehouse]], np. [[Delta Lake|Delta Lake]]) do automatycznego dostosowania struktury tabeli do nowych danych, bez psucia danych historycznych. Pozwala na dodawanie nowych kolumn lub zmianę typów "w locie" podczas zapisu.
...
- **Gdzie:** [[Delta Lake|Delta Lake]] (opcja `mergeSchema`), Iceberg, Hudi.

# 📚 Szczegółowe wyjaśnienie
Typy ewolucji w [[Delta Lake|Delta Lake]]:
