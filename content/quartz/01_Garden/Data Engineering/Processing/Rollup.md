...
Najczęściej używane w [[SQL|SQL]] (`GROUP BY ROLLUP`) oraz w narzędziach OLAP.
...
W [[SQL|SQL]] `GROUP BY ROLLUP (Region, Sklep)` wygeneruje 3 poziomy danych w jednym wyniku:
...
## 👽 Brudnopis
- W czasach Big Data ([[Snowflake|Snowflake]], BigQuery) rollupy są mniej krytyczne niż kiedyś (bo bazy są super szybkie), ale nadal oszczędzają pieniądze (płacisz za przetworzone bajty). Skanowanie 1KB Rollupa vs 1TB Raw Data to duża różnica w cenie.