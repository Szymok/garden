...
---
# 🎯 Definicja
**Manual [[Profiling|Profiling]]** (Ręczne Profilowanie) to proces, w którym użytkownik "na żądanie" uruchamia analizę jakości danych dla wybranej tabeli lub pliku. W odróżnieniu od profilowania automatycznego (działającego w nocy dla całego systemu), tutaj to analityk decyduje: "Chcę sprawdzić tę tabelę TERAZ".
...
- **Tryby:**
    - **Import [[Metadata|Metadata]]:** Tylko nazwy kolumn (błyskawiczne).
    - **Data Sample:** Analiza pierwszych 1000 wierszy (szybkie).
    - **Full [[Profiling|Profiling]]:** Analiza każdego rekordu (wolne, ale dokładne).
...
Manual [[Profiling|Profiling]] pokaże:
...
Uruchamiasz "Full [[Profiling|Profiling]]" w [[Ataccama|Ataccama]] ONE.
...
## 📌 Źródła
- [[Ataccama|Ataccama]] [[Data Quality|Data Quality]] User Guide.
