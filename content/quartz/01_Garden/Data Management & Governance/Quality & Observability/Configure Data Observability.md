...
---
# 🎯 Definicja
**[[Data Observability|Data Observability]]** (Obserwowalność Danych) w [[Ataccama|Ataccama]] ONE to moduł od "pilnowania" danych. W przeciwieństwie do reguł DQ (które sprawdzają *treść*), Observability sprawdza *metadane i statystyki*: czy dane w ogóle przyszły? Czy wolumen jest taki jak zawsze? Czy schemat się nie zmienił?
...
- **Konfiguracja:** Wymaga włączenia na poziomie Źródła ([[Data Source|Data Source]]) lub Tabeli.

# 📚 Szczegółowe wyjaśnienie
Proces konfiguracji:
1. **Włącz Monitoring:** Wchodzisz w [[Data Source|Data Source]] -> Observability -> Enable.
...
[[Data Observability|Data Observability]] o 4:00 rano krzyczy: *"Anomalia Row Count! Oczekiwano ~50,000, otrzymano 0. Odchylenie > 3 sigma."*
Inżynier wstaje i naprawia, zanim biznes przyjdzie do pracy.

## 📌 Źródła
- [[Ataccama|Ataccama]] ONE [[Data Observability|Data Observability]] Guide.
