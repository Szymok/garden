...
---
# 🎯 Definicja
Zbiór wymagań technicznych dotyczących komunikacji sieciowej między komponentami platformy [[Ataccama|Ataccama]] ONE a zewnętrznymi systemami i źródłami danych, niezbędny do poprawnego działania procesów przetwarzania danych.
...
- **Kluczowe komponenty:** Głównymi "konsumentami" połączeń są DPE (Data Processing Engine) oraz silniki serwerowe (MDM, [[RDM|RDM]], DQIT).

# 📚 Szczegółowe wyjaśnienie
Efektywność przetwarzania danych (ETL, Profilowanie, MDM) zależy od niskiego opóźnienia i wysokiej przepustowości łącza. [[Ataccama|Ataccama]] wymaga, aby każdy serwer, na którym uruchomiony jest silnik przetwarzania (**DPE**), miał bezpośrednią "widoczność" sieciową serwera [[Bazy danych|bazy danych]].
...
- **Serwer A ([[Ataccama|Ataccama]] DPE):** IP `10.0.1.5`
...
## 👽 Brudnopis
- The [[Ataccama|Ataccama]] ONE Platform needs **access to the data it processes**.
...
- The following components are responsible for data processing and require direct [[Data Source|data source]] access:
    - **Data Processing Engine (DPE)**: Every server running a DPE instance must allow connections to the required data sources.
    - **MDM, [[RDM|RDM]], DQIT**: Engine servers must have a direct connection to their respective required data sources.