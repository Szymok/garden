...
- Raporty [[Business Intelligence|BI]] są budowane w dedykowanych narzędziach [[Business Intelligence]] i mogą być integrowane, wyświetlane oraz zarządzane centralnie przez platformę taką jak [[Ataccama|Ataccama]] ONE.
...
- Centralne repozytorium raportów (np. w [[Ataccama|Ataccama]] ONE) zapobiega duplikowaniu analiz i rozproszonemu zarządzaniu wiedzą.

## Obsługa raportów w [[Ataccama|Ataccama]] ONE
...
**Scenariusz:**  
Zespół [[Business Intelligence|BI]] buduje raport sprzedażowy w Power [[Business Intelligence|BI]]. Raport zostaje zintegrowany z [[Ataccama|Ataccama]] ONE jako item katalogowy.
...
- Podstawa: Power [[Business Intelligence|BI]], Tableau, Qlik, Looker, Excel pivot – [[Ataccama|Ataccama]] umożliwia centralizację katalogu tych aktywów
