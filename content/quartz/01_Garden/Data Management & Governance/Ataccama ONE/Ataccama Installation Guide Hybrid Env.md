...
---
# 🎯 Definicja
Procedura instalacji hybrydowego silnika przetwarzania (Hybrid DPE), który łączy się z chmurą [[Ataccama|Ataccama]] Cloud ([[SaaS|SaaS]]), ale przetwarza dane lokalnie (on-premise / private cloud).
...
- **Komunikacja:** DPE musi "widzieć" chmurę [[Ataccama|Ataccama]] ([[Keycloak|Keycloak]], MinIO, DPM), ale chmura nie musi widzieć DPE (jeśli używamy bidirectional mode).

# 📚 Szczegółowe wyjaśnienie
Instalacja hybrydowa to kompromis: dane zostają u klienta (bezpieczeństwo), a metadane i UI są w chmurze (wygoda [[SaaS|SaaS]]).
...
2. Skonfiguruj sekrety (`client_id`, `client_secret` z [[Ataccama|Ataccama]] Cloud).
...
## 📌 Źródła
- [[Ataccama|Ataccama]] Installation Guide - Hybrid DPE.
