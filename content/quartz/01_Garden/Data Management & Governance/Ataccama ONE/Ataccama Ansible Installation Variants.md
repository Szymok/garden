...
---
# 🎯 Definicja
Podczas instalacji platformy [[Ataccama|Ataccama]] ONE za pomocą Ansible, musisz wybrać odpowiedni **wariant instalacji** (Inventory Variant) i odpowiadający mu **Playbook**. Wybór zależy od tego, jakie komponenty (Meduły) zakupiłeś i chcesz wdrożyć.
...
|---|---|---|---|
| **[[Ataccama|Ataccama]] ONE** | [[Data Quality|Data Quality]], Catalog, Observability | `plain` | `site.yml` |
| **ONE + DQIT** | Powyższe + Issue Tracker | `dqit` | `site.yml` |
| **Full Platform** | ONE + MDM + [[RDM|RDM]] + DQIT | `full` | `site.yml` |
| **Hybrid DPE** | Tylko silnik przetwarzania (Hybryda) | `hybrid` | `hybrid-dpe.yml` |
| **Standalone [[RDM|RDM]]** | Tylko [[Reference Data Manager|Reference Data Manager]] | `rdm_standalone` | `rdm_standalone.yml` |
| **Standalone MDM** | Tylko Master [[Data Management|Data Management]] | `mdm_standalone` | `mdm_standalone.yml` |
| **MDM + [[RDM|RDM]]** | MDM i [[RDM|RDM]] bez Katalogu | `mdmrdm` | `mdm_rdm.yml` |
