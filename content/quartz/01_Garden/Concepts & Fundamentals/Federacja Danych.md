...
Silnik (np. Trino):
1.  Wysyła zapytanie [[SQL|SQL]] do Oracle (Pushdown).
...
Zamiast budować pipeline ETL, który potrwa miesiąc, analityk podpina te trzy źródła do Trino i w 15 minut pisze zapytanie [[SQL|SQL]] łączące te trzy światy.

## 📌 Źródła
- "[[Data Virtualization|Data Virtualization]] for [[Business Intelligence|Business Intelligence]] Systems" - Rick van der Lans.
- Trino Documentation.
