...
To parasol nad Data Engineering, [[Data Governance|Data Governance]], [[Data Quality|Data Quality]] i Security.

# 🔑 Kluczowe punkty
- **Dostępność:** Dane muszą być dostępne dla tych, co ich potrzebują (Demokratyzacja).
- **Jakość:** Dane muszą być poprawne ([[Data Quality|Data Quality]]).
- **Bezpieczeństwo:** Dane nie mogą wyciec (Security/Compliance).

# 📚 Szczegółowe wyjaśnienie
Według DAMA-DMBOK (Biblii zarządzania danymi), obszary to m.in.:
1.  **[[Data Governance|Data Governance]]:** Zasady i polityki ("Kto rządzi?").
...
4.  **[[Data Quality|Data Quality]]:** Ciągłe monitorowanie błędów.
...
2.  [[Data Governance|Data Governance]] (Zasada: "Pole NIP jest obowiązkowe").
3.  [[Data Quality|Data Quality]] (Raport błędnych NIPów co rano).
