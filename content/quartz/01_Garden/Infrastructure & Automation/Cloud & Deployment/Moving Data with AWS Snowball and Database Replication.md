...
- **AWS DMS (Database Migration Service):** Pozwala na migrację baz jednorodnych (np. Oracle do Oracle) i różnorodnych (np. [[SQL|SQL]] Server do MySQL) z minimalnym czasem przestoju.
...
- **[[Backup|Backup]] korporacyjny:** Przenoszenie wieloletnich archiwów i kopii zapasowych serwerów za pomocą Snowball.
- **Modernizacja [[Bazy danych|bazy danych]]:** Upgrade starych systemów do nowoczesnych platform chmurowych (np. Aurora) bez wyłączania aplikacji.
