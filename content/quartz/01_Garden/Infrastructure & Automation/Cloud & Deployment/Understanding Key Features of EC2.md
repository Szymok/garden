...
- **Typy instancji:**
  ...
  - **Storage Optimized:** Dla szybkich operacji wejścia/wyjścia ([[Bazy danych|bazy danych]]).
  - **Accelerated Computing:** Wykorzystuje GPU ([[Machine Learning|machine learning]], renderowanie 3D).
